...
public class ZPLConveter
{
	...
	public ZPLConveter(int positionX, int positionY) {
	...
	private String createBody(BufferedImage orginalImage) throws IOException {
		...
		graphics.drawImage(orginalImage, positionX, positionY, null);
	...
	private String headDoc() {
		String str = "^FO"+positionX+","+positionY+"^GFA," + total + "," + total + "," + widthBytes + ", ";
		return str;
	}
	...
	/*public static void main(String[] args) throws Exception {
		...
		ZPLConveter zp = new ZPLConveter(10,10);
