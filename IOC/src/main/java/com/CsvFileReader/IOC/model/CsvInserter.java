package com.CsvFileReader.IOC.model;
...
/* POJO CLASS for the CsvInserter application
 *  with respect to csv file*/
@Entity
@Table(name = "BI_reserve_screen_report")
public class CsvInserter
{
	...
	private String location_Type;
	  ...
	  @Column(name = "location_Size_Type") 
	...
	private String is_Parent;
	  ...
	  @Column(name = "alternative_Item_Code") 
	...
	private String current_LPN;
	  
	  @Column(name = "alloc_LPN") 
	private String alloc_LPN;
	  
	  @Column(name = "last_CC_Counted") 
	private String last_CC_Counted;
	  
	  @Column(name = "mod_TimeStamp") 
	private String mod_TimeStamp;
	  
	  @Column(name = "to_be_Counted") 
	private String to_be_Counted;
	  
	  @Column(name = "to_Be_Counted_TS") 
	private String to_Be_Counted_TS;
	  
	  @Column(name = "loc_Lock") 
	private String loc_Lock;
	...
	private String mod_User;
	  ...
	  @Column(name = "loc_CC_User") 
	private String loc_CC_User;
	  
	  @Column(name = "loc_Max_LPN") 
	private String loc_Max_LPN;
	  
	  @Column(name = "loc_Max_Unit") 
	private String loc_Max_Unit;
	  
	  @Column(name = "min_Unit") 
	private String min_Unit;
	  
	  @Column(name = "attribute_A") 
	private String attribute_A;
	  
	  
	  @Column(name = "attribute_B") 
	private String attribute_B;
	  
	  @Column(name = "attribute_C") 
	private String attribute_C;
	  
	  @Column(name = "attribute_D") 
	private String attribute_D;
	  
	  @Column(name = "attribute_E") 
	private String attribute_E;
	  @Column(name = "attribute_F") 
	private String attribute_F;
	  @Column(name = "attribute_G") 
	private String attribute_G;
	  @Column(name = "attribute_H") 
	private String attribute_H;
	  @Column(name = "attribute_I") 
	private String attribute_I;
	  @Column(name = "attribute_J") 
	private String attribute_J;
	  @Column(name = "attribute_K") 
	private String attribute_K;
	  @Column(name = "attribute_L") 
	private String attribute_L;
	  @Column(name = "attribute_M") 
	private String attribute_M;
	  @Column(name = "attribute_N") 
	private String attribute_N;
	  @Column(name = "attribute_O") 
	private String attribute_O;
	  
	  @Column(name = "brand_Code") 
	private String brand_Code;
	  
	  @Column(name = "batch_Nbr_Lock") 
	...
	public CsvInserter(int id, String location_Type, String location_Size_Type, String location_Area,
			String item_Code, String is_Parent, String alternative_Item_Code, String item_Description, String batch_Nbr,
			String expiry_Date, String current_Qty, String allocated_Qty, String current_LPN, String alloc_LPN,
			String last_CC_Counted, String mod_TimeStamp, String to_be_Counted, String to_Be_Counted_TS,
			String loc_Lock, String location_Barcode, String facility, String display_Text, String mod_User,
			String loc_CC_User, String loc_Max_LPN, String loc_Max_Unit, String min_Unit, String attribute_A,
			...
			String attribute_L, String attribute_M, String attribute_N, String attribute_O, String brand_Code,
			String batch_Nbr_Lock, String company, String lock_Code) {
		super();
		this.id = id;
		...
		this.current_LPN = current_LPN;
		this.alloc_LPN = alloc_LPN;
		this.last_CC_Counted = last_CC_Counted;
		this.mod_TimeStamp = mod_TimeStamp;
		this.to_be_Counted = to_be_Counted;
		this.to_Be_Counted_TS = to_Be_Counted_TS;
		this.loc_Lock = loc_Lock;
		this.location_Barcode = location_Barcode;
		this.facility = facility;
		this.display_Text = display_Text;
		this.mod_User = mod_User;
		this.loc_CC_User = loc_CC_User;
		this.loc_Max_LPN = loc_Max_LPN;
		this.loc_Max_Unit = loc_Max_Unit;
	...
	public String getCurrent_LPN() {
		return current_LPN;
	}

	public void setCurrent_LPN(String current_LPN) {
		this.current_LPN = current_LPN;
	}

	public String getAlloc_LPN() {
		return alloc_LPN;
	}

	public void setAlloc_LPN(String alloc_LPN) {
		this.alloc_LPN = alloc_LPN;
	}

	public String getLast_CC_Counted() {
		return last_CC_Counted;
	}

	public void setLast_CC_Counted(String last_CC_Counted) {
		this.last_CC_Counted = last_CC_Counted;
	}
	...
	public String getTo_be_Counted() {
		return to_be_Counted;
	}

	public void setTo_be_Counted(String to_be_Counted) {
		this.to_be_Counted = to_be_Counted;
	}
	...
	public String getLoc_Lock() {
		return loc_Lock;
	}

	public void setLoc_Lock(String loc_Lock) {
		this.loc_Lock = loc_Lock;
	}
	...
	public String getLoc_CC_User() {
		return loc_CC_User;
	}

	public void setLoc_CC_User(String loc_CC_User) {
		this.loc_CC_User = loc_CC_User;
	}

	public String getLoc_Max_LPN() {
		return loc_Max_LPN;
	}

	public void setLoc_Max_LPN(String loc_Max_LPN) {
		this.loc_Max_LPN = loc_Max_LPN;
	}

	public String getLoc_Max_Unit() {
		return loc_Max_Unit;
	}

	public void setLoc_Max_Unit(String loc_Max_Unit) {
		this.loc_Max_Unit = loc_Max_Unit;
	}
	...
	public String toString() {
		return "CsvInserter [id=" + id + ", location_Type=" + location_Type + ", location_Size_Type="
				+ location_Size_Type + ", location_Area=" + location_Area + ", item_Code=" + item_Code + ", is_Parent="
				+ is_Parent + ", alternative_Item_Code=" + alternative_Item_Code + ", item_Description="
				+ item_Description + ", batch_Nbr=" + batch_Nbr + ", expiry_Date=" + expiry_Date + ", current_Qty="
				+ current_Qty + ", allocated_Qty=" + allocated_Qty + ", current_LPN=" + current_LPN + ", alloc_LPN="
				+ alloc_LPN + ", last_CC_Counted=" + last_CC_Counted + ", mod_TimeStamp=" + mod_TimeStamp
				+ ", to_be_Counted=" + to_be_Counted + ", to_Be_Counted_TS=" + to_Be_Counted_TS + ", loc_Lock="
				+ loc_Lock + ", location_Barcode=" + location_Barcode + ", facility=" + facility + ", display_Text="
				+ display_Text + ", mod_User=" + mod_User + ", loc_CC_User=" + loc_CC_User + ", loc_Max_LPN="
				+ loc_Max_LPN + ", loc_Max_Unit=" + loc_Max_Unit + ", min_Unit=" + min_Unit + ", attribute_A="
				+ attribute_A + ", attribute_B=" + attribute_B + ", attribute_C=" + attribute_C + ", attribute_D="
				+ attribute_D + ", attribute_E=" + attribute_E + ", attribute_F=" + attribute_F + ", attribute_G="
				+ attribute_G + ", attribute_H=" + attribute_H + ", attribute_I=" + attribute_I + ", attribute_J="
				+ attribute_J + ", attribute_K=" + attribute_K + ", attribute_L=" + attribute_L + ", attribute_M="
				+ attribute_M + ", attribute_N=" + attribute_N + ", attribute_O=" + attribute_O + ", brand_Code="
				+ brand_Code + ", batch_Nbr_Lock=" + batch_Nbr_Lock + ", company=" + company + ", lock_Code="
				+ lock_Code + "]";
	}
