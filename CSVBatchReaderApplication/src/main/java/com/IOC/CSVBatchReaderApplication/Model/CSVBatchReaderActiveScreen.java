...
public class CSVBatchReaderActiveScreen 
{
...
public CSVBatchReaderActiveScreen()
{
	super();
}
public CSVBatchReaderActiveScreen(int report_id, String facility, String location, String location_Barcode,
		...
		String to_Be_Counted_TS, String location_Lock_Code, String mod_User, String last_Counted_By, String max_Units,
		String max_Lpns, String min_Units, String batch_Nbr_Lock, String in_Transit, String brand_Code,
		String priority_date, String maximum_Volume, String putaway_Type, String attribute_A, String attribute_B,
		...
		String attribute_M, String attribute_N, String attribute_O, String replenishment_Zone, String company) {
	super();
...
public String toString() {
	return "CSVBatchReaderActiveScreen [report_id=" + report_id + ", facility=" + facility + ", location=" + location
			+ ", location_Barcode=" + location_Barcode + ", location_Type=" + location_Type + ", location_Size_Type="
			+ location_Size_Type + ", area=" + area + ", item_Assignment_Type=" + item_Assignment_Type
			+ ", hierarchy_Code_3=" + hierarchy_Code_3 + ", item_Code=" + item_Code + ", is_Parent=" + is_Parent
			+ ", alternative_Item_Code=" + alternative_Item_Code + ", item_Description=" + item_Description
			+ ", current_Qty=" + current_Qty + ", allocated_Qty=" + allocated_Qty + ", batch_Nbr=" + batch_Nbr
			+ ", expiry_date=" + expiry_date + ", orig_Qty=" + orig_Qty + ", last_Counted_At=" + last_Counted_At
			+ ", mod_Time_Stamp=" + mod_Time_Stamp + ", to_Be_Counted_Flag=" + to_Be_Counted_Flag
			+ ", to_Be_Counted_TS=" + to_Be_Counted_TS + ", location_Lock_Code=" + location_Lock_Code + ", mod_User="
			+ mod_User + ", last_Counted_By=" + last_Counted_By + ", max_Units=" + max_Units + ", max_Lpns=" + max_Lpns
			+ ", min_Units=" + min_Units + ", batch_Nbr_Lock=" + batch_Nbr_Lock + ", in_Transit=" + in_Transit
			+ ", brand_Code=" + brand_Code + ", priority_date=" + priority_date + ", maximum_Volume=" + maximum_Volume
			+ ", putaway_Type=" + putaway_Type + ", attribute_A=" + attribute_A + ", attribute_B=" + attribute_B
			...
			+ ", attribute_O=" + attribute_O + ", replenishment_Zone=" + replenishment_Zone + ", company=" + company
			+ "]";
}
}