package com.OIC.fileDataReader.dto;
...
@Entity
public class ExcelFileDataInserter
{
	@Id
	...
	public ExcelFileDataInserter() 
	{
		super();
	}

	public ExcelFileDataInserter(int id, String location_Type, String location_Size_Type, String location_Area,
			...
			String last_CC_Counted, String mod_TimeStamp, String to_be_Counted, String to_Be_Counted_TS, String loc_Lock,
			String location_Barcode, String facility, String display_Text, String mod_User, String loc_CC_User,
			String loc_Max_LPN, String loc_Max_Unit, String min_Unit, String attribute_A, String attribute_B,
			String attribute_C, String attribute_D, String attribute_E, String attribute_F, String attribute_G,
			String attribute_H, String attribute_I, String attribute_J, String attribute_K, String attribute_L,
			String attribute_M, String attribute_N, String attribute_O, String brand_Code, String batch_Nbr_Lock,
			String company, String lock_Code) {
		super();
		this.id = id;
	...
	public String toString() {
		return "ExcelFileDataInserter [id=" + id + ", location_Type=" + location_Type + ", location_Size_Type="
				+ location_Size_Type + ", location_Area=" + location_Area + ", item_Code=" + item_Code + ", is_Parent="
				+ is_Parent + ", alternative_Item_Code=" + alternative_Item_Code + ", item_Description=" + item_Description
				+ ", batch_Nbr=" + batch_Nbr + ", expiry_Date=" + expiry_Date + ", current_Qty=" + current_Qty
				+ ", allocated_Qty=" + allocated_Qty + ", current_LPN=" + current_LPN + ", alloc_LPN=" + alloc_LPN
				+ ", last_CC_Counted=" + last_CC_Counted + ", mod_TimeStamp=" + mod_TimeStamp + ", to_be_Counted="
				+ to_be_Counted + ", to_Be_Counted_TS=" + to_Be_Counted_TS + ", loc_Lock=" + loc_Lock
				+ ", location_Barcode=" + location_Barcode + ", facility=" + facility + ", display_Text=" + display_Text
				+ ", mod_User=" + mod_User + ", loc_CC_User=" + loc_CC_User + ", loc_Max_LPN=" + loc_Max_LPN
				+ ", loc_Max_Unit=" + loc_Max_Unit + ", min_Unit=" + min_Unit + ", attribute_A=" + attribute_A
				+ ", attribute_B=" + attribute_B + ", attribute_C=" + attribute_C + ", attribute_D=" + attribute_D
				+ ", attribute_E=" + attribute_E + ", attribute_F=" + attribute_F + ", attribute_G=" + attribute_G
				+ ", attribute_H=" + attribute_H + ", attribute_I=" + attribute_I + ", attribute_J=" + attribute_J
				+ ", attribute_K=" + attribute_K + ", attribute_L=" + attribute_L + ", attribute_M=" + attribute_M
				+ ", attribute_N=" + attribute_N + ", attribute_O=" + attribute_O + ", brand_Code=" + brand_Code
				+ ", batch_Nbr_Lock=" + batch_Nbr_Lock + ", company=" + company + ", lock_Code=" + lock_Code + "]";
	}
