...
public class BatchConfig extends DefaultBatchConfigurer
{
	...
	public Job reserveJob(NotificationListener listener,Step reserveStep) throws SQLException, FileUploadException, MessagingException {
	...
	@Bean(name = "activeJob")
	public Job activeJob(NotificationListener listener,Step activeStep) throws SQLException, FileUploadException, MessagingException {
		return jobBuilderFactory
				.get("activeJob")
				.incrementer(new RunIdIncrementer())
				.listener(listener)
	...
	public Job ib_shipment_Job(NotificationListener listener,Step ib_shipment_Step) throws SQLException, FileUploadException, MessagingException {
		return jobBuilderFactory
				.get("ib_shipment_Job")
				.incrementer(new RunIdIncrementer())
				.listener(listener)
	...
	public Job order_Details_Job(NotificationListener listener,Step order_Details_Step) throws SQLException, FileUploadException, MessagingException {
		return jobBuilderFactory
	...
	public Job iblpn_Details_Job(NotificationListener listener,Step iblpn_Details_Step) throws SQLException, FileUploadException, MessagingException {
		return jobBuilderFactory
	...
	public Job iblpn_Reports_Job(NotificationListener listener,Step iblpn_Reports_Step) throws SQLException, FileUploadException, MessagingException {
		return jobBuilderFactory
	...
	@Bean
	public Step reserveStep() throws SQLException, FileUploadException, MessagingException {
	...
	@Bean
	public Step activeStep() throws SQLException, FileUploadException, MessagingException {
		return stepBuilderFactory
				.get("activeStep")
	...
	@Bean
	public Step ib_shipment_Step() throws SQLException, FileUploadException, MessagingException {
		return stepBuilderFactory
				.get("ib_shipment_Job")
	...
	@Bean
	public Step order_Details_Step() throws SQLException, FileUploadException, MessagingException {
		return stepBuilderFactory
				.get("order_Details_Job")
	...
	@Bean
	public Step iblpn_Details_Step() throws SQLException, FileUploadException, MessagingException {
		return stepBuilderFactory
				.get("iblpn_Details_Job")
	...
	@Bean
	public Step iblpn_Reports_Step() throws SQLException, FileUploadException, MessagingException {
		return stepBuilderFactory
				.get("iblpn_Reports_Job")
	...
	@Bean
	public JdbcBatchItemWriter<ActiveScreenReport> activeWriter() throws SQLException, MessagingException{
		...
		try {
			...
			logger.info("unable to INSERT INTO BI_REP_ORDER_DETAILS");
			startlinkBIReporting.notification(e);
		}
		return itemWriter;
	}
	@Bean
	public JdbcBatchItemWriter<ReserveScreenReport> reserveWriter() throws SQLException, MessagingException {
	...
	@Bean
	public JdbcBatchItemWriter<IBShipmentReport> ib_shipment_Writer() throws SQLException, MessagingException {
	...
	@Bean
	public JdbcBatchItemWriter<OrderDetailsReport> order_Details_Writer() throws SQLException, MessagingException {
		JdbcBatchItemWriter<OrderDetailsReport> itemWriter =null;
		itemWriter = new JdbcBatchItemWriter<OrderDetailsReport>();
		try {
			DataSource dataSource=getDataSource();
			itemWriter.setDataSource(dataSource);
	...
	@Bean
	public JdbcBatchItemWriter<IBLPNDetailsReport> iblpn_Details_Writer() throws SQLException, MessagingException {
	...
	@Bean
	public JdbcBatchItemWriter<IBLPNReports> iblpn_Reports_Writer() throws SQLException, MessagingException {
	...
	public DataSource getDataSource() throws MessagingException { 
